...
TESTN::TESTN(int _player_num,
    ...
    std::map<int, tutil::skill> _using_skill,
...
void TESTN::info() const {
    ...
    for (int player: players) {
        std::cout << "\tPlayer " << player << ": ";
        if (using_skill.at(player) == tutil::none) {
            std::cout << "None";
        }
        else {
...
const TESTN test1 = TESTN(4,
    ...
    gen_map<int, tutil::skill>(4, gen_default_player(4), {tutil::clap, tutil::none, tutil::clap, tutil::none}),
...
const TESTN test2 = TESTN(4, 
    ...
    gen_all_alive(gen_default_player(4)), 
    gen_map<int, std::map<int, int>>(4, gen_default_player(4), gen_repeated_vec(gen_cleared_skl(), 4)), 
    gen_map<int, tutil::skill>(4, gen_default_player(4), gen_repeated_vec(tutil::none, 4)), 
    gen_map<int, int>(4, gen_default_player(4), gen_repeated_vec(0, 4)), 
    gen_map<int, bool>(4, gen_default_player(4), gen_repeated_vec(false, 4)), 
    gen_map<int, float>(4, gen_default_player(4), gen_repeated_vec<float>(0, 4)), 
    "Null 局");
...
const TESTN test3 = TESTN(4, 
    ...
    gen_all_alive(gen_default_player(4)),
    gen_map<int, std::map<int, int>>(4, gen_default_player(4), gen_repeated_vec(gen_cleared_skl(), 4)),
    gen_map<int, tutil::skill>(4, gen_default_player(4), {tutil::wooden_axe, tutil::normal_axe, tutil::enchanted_axe, tutil::enchanted_axe}),
    gen_map<int, int>(4, gen_default_player(4), gen_repeated_vec(0, 4)),
...
const TESTN test4 = TESTN(2,
    ...
    gen_map<int, tutil::skill>(2, gen_default_player(2), {tutil::wooden_axe, tutil::clap}),
...
const TESTN test5 = TESTN(3, 
    ...
    gen_map<int, tutil::skill>(3, gen_default_player(3), {tutil::wooden_axe, tutil::wooden_axe, tutil::clap}),
...
const TESTN test6 = TESTN(3,
    ...
    gen_all_alive(gen_default_player(3)),
    gen_map<int, std::map<int, int>>(3, gen_default_player(3), gen_repeated_vec(gen_cleared_skl(), 3)),
    gen_map<int, tutil::skill>(3, gen_default_player(3), {tutil::wooden_axe, tutil::normal_axe, tutil::clap}),
    gen_map<int, int>(3, gen_default_player(3), gen_repeated_vec(0, 3)),
...
const TESTN test7 = TESTN(3,
    ...
    gen_all_alive(gen_default_player(3)),
    gen_map<int, std::map<int, int>>(3, gen_default_player(3), gen_repeated_vec(gen_cleared_skl(), 3)),
    gen_map<int, tutil::skill>(3, gen_default_player(3), {tutil::clap, tutil::clap, tutil::wooden_sword}),
...
const TESTN test9 = TESTN(2,
    ...
    gen_all_alive(gen_default_player(2)),
    gen_map<int, std::map<int, int>>(2, gen_default_player(2), gen_repeated_vec(gen_cleared_skl(), 2)),
    gen_map<int, tutil::skill>(2, gen_default_player(2), {tutil::diamond_axe, tutil::wooden_sword}),
...
const TESTN test10 = TESTN(3,
    ...
    gen_map<int, std::map<int, int>>(3, gen_default_player(3), gen_repeated_vec(gen_cleared_skl(), 3)),
    gen_map<int, tutil::skill>(3, gen_default_player(3), {tutil::diamond_axe, tutil::wooden_sword, tutil::wooden_sword}),
...
const TESTN test11 = TESTN(3,
    ...
    gen_all_alive(gen_default_player(3)),
    gen_map<int, std::map<int, int>>(3, gen_default_player(3), gen_repeated_vec(gen_cleared_skl(), 3)),
    gen_map<int, tutil::skill>(3, gen_default_player(3), {tutil::enchanted_axe, tutil::wooden_sword, tutil::wooden_sword}),
    gen_map<int, int>(3, gen_default_player(3), {0, 1, 1}),
...
const TESTN test12 = TESTN(2,
    ...
    gen_all_alive(gen_default_player(2)),
    gen_map<int, std::map<int, int>>(2, gen_default_player(2), gen_repeated_vec(gen_cleared_skl(), 2)),
    gen_map<int, tutil::skill>(2, gen_default_player(2), {tutil::clap, tutil::yellow_sword}),
    gen_map<int, int>(2, gen_default_player(2), {0, 1}),
    gen_map<int, bool>(2, gen_default_player(2), {true, false}),
    gen_map<int, float>(2, gen_default_player(2), {0, 0}),
    "单黄局 1");
...
const TESTN test13 = TESTN(3,
    ...
    gu(3, gdp(3), {tutil::defense, tutil::hither, tutil::hither}),
...
const TESTN test14 = TESTN(2,
    ...
    gen_all_alive(gen_default_player(2)),
    gen_map<int, std::map<int, int>>(2, gen_default_player(2), gen_repeated_vec(gen_cleared_skl(), 2)),
    gen_map<int, tutil::skill>(2, gen_default_player(2), {tutil::defense, tutil::yellow_sword}),
    gen_map<int, int>(2, gen_default_player(2), {0, 1}),
